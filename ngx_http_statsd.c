...
static ngx_http_module_t ngx_http_statsd_module_ctx = {
        ...
        ngx_http_statsd_create_loc_conf,       /* create location configuration */
        ngx_http_statsd_merge_loc_conf         /* merge location configuration */
};
...
static ngx_int_t ngx_statsd_init_endpoint(ngx_conf_t *cf, ngx_udp_endpoint_t *endpoint) {
    ...
    ngx_log_debug0(NGX_LOG_DEBUG_HTTP, cf->log, 0, "statsd: initializing endpoint");
